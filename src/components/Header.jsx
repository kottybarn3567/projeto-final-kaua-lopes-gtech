...
const Header = () => {
  ...
  return (
    <header className="header bg-white flex-col">
      <div className="d-flex align-i-center w-full justi-cont-sp-between">
        ...
        <DivContainerAcess className="acessos relative">
          <Link style={{ width: "118px" }} className="underline-text">
            Cadastrar-se
          </Link>

          <button className="button-general bg-primary-btn pointer transiton02s">
            Entrar
          </button>
          ...
          <div className="got-products bg-error d-flex align-i-center justi-cont-center absolute text-white">
            0
          </div>
        </DivContainerAcess>
      </div>
      ...
      <NavContainer>
        <ul className="d-flex">
          ...
          <li className="pointer">
            <NavLink to={"product-listing-page"}>Produtos</NavLink>
          </li>
          <li className="pointer">
            <NavLink to={"error"}>Categorias</NavLink>
          </li>
          <li className="pointer">
            <NavLink to={"error"}>Meus Pedidos</NavLink>
          </li>
        </ul>
      </NavContainer>
    </header>
